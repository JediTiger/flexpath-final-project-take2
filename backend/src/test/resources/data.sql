...
-- 3rd: Vehicles
INSERT INTO `vehicles` VALUES (1,'user 1','Honda','Civic',2018,0),(2,'user 1','Ford','F-150',2021,1),(3,'user 2','BMW','Classy',2026,0),(4,'user 2','Ferarri','F-1550',2021,1),(5,'user 1','Chevrolet','Impala',1978,0),(6,'user 2','GMC','Acadia',2016,1);
